...
public class ParkingLotTest {
    ...
    @Test
    void should_given_parking_lot_parking_boy_and_used_ticket_when_fetch_then_return_nothing_with_error_message() {
        // Given
        ParkingLot parkingLot = new ParkingLot(10);
        ParkingBoy parkingBoy = new ParkingBoy(parkingLot);
        Car parkedCar = new Car();
    ...
    @Test
    void should_given_parking_lot_without_any_position_parking_boy_and_car_when_park_then_return_nothing_with_error_message() {
        // Given
        ParkingLot parkingLot = new ParkingLot(0);
        ParkingBoy parkingBoy = new ParkingBoy(parkingLot);
        Car car = new Car();
